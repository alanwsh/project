            ...
            <?php //echo form_open('product/insert_product');?>
                <h1>Update Product</h1>
                    ...
                    <div class = "input-file">
                        ...
                        <?php
                        if($this->session->userdata('temp_img_path')){
                        $temp_img_path = $this->session->userdata('temp_img_path');
                            echo "<img src = 'image/temp/".$temp_img_path."' id = 'preview'>";
                        }
                        else
                        echo "<img src = 'image/upload_image.jpg' id = 'preview'>";
                        ?>
